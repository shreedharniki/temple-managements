...
// import "./LoginPage.css"; // Use the CSS you provided

// export default function LoginPage() {
//   const dispatch = useDispatch();
//   const navigate = useNavigate();

//   const { step, loading, alert } = useSelector((state) => state.auth);
...
//           <Button onClick={() => dispatch(loginUser({ email: formRef.current.email, password: formRef.current.password }))}>Login</Button>
//           <Button variant="secondary" onClick={() => dispatch(setStep("forgot"))}>Forgot Password?</Button>
//         </>}
...
//             ))}
//           </div>
//           <Button onClick={() => dispatch(verifyOtp({ email: formRef.current.email, otp: formRef.current.otp }))}>Verify OTP</Button>
...
//           <Button onClick={() => dispatch(resetPassword({ email: formRef.current.email, otp: formRef.current.otp, newPassword: formRef.current.newPassword }))}>Reset Password</Button>
//           <Button variant="secondary" onClick={() => dispatch(setStep("login"))}>Back to Login</Button>
//         </>}
//       </div>
//     </div>
...
import Alert from "../../components/ui/Alert";
import { loginUser, forgotPassword, verifyOtp, resetPassword, setStep } from "../../store/authSlice";
import "./LoginPage.css"; // Your CSS

export default function LoginPage() {
  const dispatch = useDispatch();
  const navigate = useNavigate();
  const { step, loading, alert, user } = useSelector((state) => state.auth);
