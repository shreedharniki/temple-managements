...
//    const handleAssignModules = (item) => navigate(`/temples/${item.id}/modules`);
...
//               {role === "super_admin" && (
//               <IconButton icon={FaPlus} label="Assign Modules" onClick={() => navigate(`/temples/${temple.Id}/modules`)} />
//               )}
...
//                         <IconButton icon={FaPlus} label="Assign Modules" onClick={() => navigate(`/temple/${row.id}/modules`)}/>
      ...
      {loading ? (
        ...
        <Table
          ...
          renderRowActions={(row) => (
            <div style={{ display: "flex", gap: "6px" }}>
              <IconButton icon={FaEdit} onClick={() => handleEdit(row)} variant="secondary" />
              <IconButton icon={FaEye} onClick={() => navigate(`/temples/${row.id}/settings`)} variant="primary" />
              {role === "super_admin" && (
                <>
                  <IconButton icon={FaTrash} onClick={() => handleDelete(row)} variant="destructive" />
                  {/* <IconButton icon={FaPlus} label="Assign Modules" onClick={() => handleAssignModules(row)} /> */}
                  <IconButton
  icon={FaPlus}
  label="Assign Modules"
  onClick={() => navigate(`/temple/${row.id}/modules`)}
/>
